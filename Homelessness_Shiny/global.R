...
# Multi Year Data
multi_year <- read_csv("Final CSVs/Homelessness_Multi_Year_Final.csv") %>%
  select(-X1) %>% 
...
unsheltered_2016 <- read_csv("Final CSVs/Demo_2016_Full_Final.csv") %>% 
  select(-X1)
...
unsheltered_2017 <- read_csv("Final CSVs/Demo_2017_Final.csv") %>% 
  select(-X1)
...
#2016 Sheltered Data 
sheltered_2016 <- read_csv("Final CSVs/HMIS_2016_Final.csv")
...
sheltered_2016$Current_Stint_Duration <- fct_relevel(as.factor(sheltered_2016$Current_Stint_Duration), 
                                                               "Less than 12 months")
#2017 Sheltered Data
sheltered_2017 <- read_csv("Final CSVs/HMIS_2017_Final.csv")
